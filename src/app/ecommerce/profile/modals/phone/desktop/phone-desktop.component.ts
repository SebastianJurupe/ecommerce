...
@Component({
  templateUrl: 'phone-desktop.component.html',
  styleUrls: ['phone-desktop.component.scss'],
  host: { 'app.phone-desktop': 'true' }
})
export class PhoneDesktopComponent extends ViewComponent {
