...
@Component({
  templateUrl: 'password-desktop.component.html',
  styleUrls: ['password-desktop.component.scss'],
  host: { 'app.password-desktop': 'true' }
})
export class PasswordDesktopComponent extends ViewComponent {
