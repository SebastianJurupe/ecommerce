...
@Component({
  templateUrl: 'privacy-policies-mobile.component.html',
  styleUrls: ['privacy-policies-mobile.component.scss'],
  host: { 'app.privacy-policies-mobile': 'true' }
})
export class PrivacyPoliciesMobileComponent extends ViewComponent implements OnInit, OnDestroy {
