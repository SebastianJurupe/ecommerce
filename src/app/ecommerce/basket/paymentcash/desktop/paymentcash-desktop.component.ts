...
@Component({
  templateUrl: 'paymentcash-desktop.component.html',
  styleUrls: ['paymentcash-desktop.component.scss'],
  host: { 'app.paymentcash-desktop': 'true' }
})
export class PaymentcashDesktopComponent extends ViewComponent {
