...
@Component({
  templateUrl: 'yape-payment-mobile.component.html',
  styleUrls: ['yape-payment-mobile.component.scss'],
  host: { 'app.yape-payment-mobile': 'true' }
})
export class YapePaymentMobileComponent extends ViewComponent implements OnInit {
