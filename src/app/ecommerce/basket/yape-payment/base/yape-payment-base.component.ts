...
@Component({
  templateUrl: 'yape-payment-base.component.html',
  styleUrls: ['yape-payment-base.component.scss'],
  host: { 'app.yape-payment-base': 'true' }
})
export class YapePaymentBaseComponent extends ViewComponent implements OnInit {
