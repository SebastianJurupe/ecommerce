...
@Component({
  templateUrl: 'yape-payment-desktop.component.html',
  styleUrls: ['yape-payment-desktop.component.scss'],
  host: { 'app.yape-payment-desktop': 'true' }
})
export class YapePaymentDesktopComponent extends ViewComponent implements OnInit {
