...
@Component({
  templateUrl: 'deposit-payment-base.component.html',
  styleUrls: ['deposit-payment-base.component.scss'],
  host: { 'app.deposit-payment-base': 'true' }
})
export class DepositPaymentBaseComponent extends ViewComponent {
