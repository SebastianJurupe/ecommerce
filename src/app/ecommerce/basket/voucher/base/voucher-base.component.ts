...
@Component({
  templateUrl: 'voucher-base.component.html',
  styleUrls: ['voucher-base.component.scss'],
  host: { 'app.voucher-base': 'true' }
})
export class VoucherBaseComponent extends ViewComponent implements OnInit {
